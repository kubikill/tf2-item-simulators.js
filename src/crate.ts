...
export const unusualPool = [5, 6, 13, 14, 21, 22, 23, 28, 29, 30, 34, 35, 36, 43, 44, 45, 46, 47, 48, 49, 51, 52, 54, 55, 56, 57, 58, 63, 64, 65, 71, 72, 73, 111, 117, 118, 122, 123, 130, 131, 133, 134, 135, 136, 137, 140, 142, 143, 147, 148, 152, 153, 157, 160, 166, 167, 172, 177, 182, 183, 187, 188, 197, 198, 204, 210, 211, 225, 230, 235, 240, 245, 246, 250, 260, 265, 266, 275, 281, 289, 290, 292, 294, 301, 303, 305, 308, 316, 317, 327, 341, 342, 343, 358, 359, 362, 366, 370, 375, 376, 383, 387, 388, 389, 390, 392, 393, 394, 395, 397, 399, 400, 401, 402, 405, 407, 408, 409, 411, 413, 414, 415, 417, 418, 420, 422, 423, 425, 427, 430, 431, 432, 433, 434, 435, 436, 438, 439, 440, 441, 454, 455, 457, 459, 460, 464, 465, 467, 470, 471, 472, 475, 479, 480, 481, 482, 483, 487, 488, 490, 492, 496, 501, 503, 504, 506, 510, 512, 516, 524, 525, 526, 537, 538, 541, 547, 549, 552, 553, 666, 685, 689, 691, 692, 693, 694, 696, 704, 705, 710, 712, 715, 718, 720, 725, 727, 732, 733, 739, 746, 749, 754, 755, 756, 777, 779, 784, 785, 786, 791, 792, 793, 794, 798, 804, 812, 815, 818, 893, 902, 905, 906, 907, 908, 909, 913, 929, 932, 933, 936, 939, 941, 942, 943, 945, 949, 953, 964, 1355, 1357, 1358, 1360, 1361, 1362, 1363, 1364, 1365, 1366, 1367, 1368, 1369, 1371, 1372, 1373, 1374, 1375, 1376, 1377, 1378, 1379, 1380, 1381, 1382, 1383, 1384, 1385, 1386, 1387, 1388, 1389, 1390, 1391, 1392, 1393, 1394, 1395, 1397, 1398, 1399, 1400, 1401, 1402, 1403, 1404, 1405, 1406, 1407, 1408, 1409, 1410, 1411, 1412, 1413, 1414, 1415, 1416, 1417, 1418, 1419, 1420, 1421];
...
const allGensFX = gen1FX.concat(gen2FX, gen3FX);
...
export const steamMarketWhitelist = [772, 773, 774, 775, 318, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 345, 346, 347, 348, 349, 350, 351, 352, 353, 673, 674, 675, 676, 677, 678, 679, 680, 681, 922, 923, 924, 925, 926, 927, 928];
...
export let cA = [
    ...
    new Crate({ id: 91, series: 133, effects: hw21FX, note: 5, unusual: 2, autoChance: 1, bonus: true, exclusiveBonus: { loot: [1745, 1746, 1747, 1748, 1749], chance: 5000 } }),
    new Crate({ id: 92, series: 134, effects: weaponFX, note: 5, unusual: 2, autoChance: 1, bonus: true }),
    new Crate({ id: 93, series: 135, effects: xmas21FX, note: 5, unusual: 2, autoChance: 1, bonus: true, exclusiveBonus: { loot: [972], chance: 4000 }, oneExclusiveBonus: true }), /* [150] */
];
...
cA[86].loot = [
    ...
    new Item({ id: 890, quality: 1 }),
    new Item({ id: 891, quality: 1 }),
    new Item({ id: 892, quality: 1 }),
    new Item({ id: 893, quality: 1 }),
    new Item({ id: 894, quality: 1 }),
    new Item({ id: 895, quality: 1 }),
    new Item({ id: 896, quality: 1 }),
    new Item({ id: 897, quality: 1 })
];
cA[87].loot = [
...
cA[105].loot = [
    ...
    new Item({ id: 1019, quality: 10, grade: 4 }),
